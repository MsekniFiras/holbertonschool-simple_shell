...
/**
* run_fork - forks and runs a program with parameters.
*
* @av: an array of strings of a program and its pramaters.
*
* Return: returns the value of a child process.
**/
...
/**
* execute_line - executes line of commands.
